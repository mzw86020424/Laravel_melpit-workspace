<nav class="navbar navbar-expand-md nav-bar-light bg-white shadow-sm">
    <div class="container">
                ...
                @else
                    ...
                    <li class="nav-item dropdown ml-2">
                        ...
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            ...
                            @else
                            <img src="/images/avatar-default.svg" class="rounded-circle" style="object-fit: cover; width:35px; height: 35px;" alt="">
                            @endif
