        ...
        <div class="col-8 offset-2 bg-white">
          ...
          <form method="POST" action="{{ route('sell') }}" class="p-5" enctype="multipart/form-data">
            ...
            <span class="item-image-form image-picker">
              <input type="file" name="item-image" class="d-none" accept="image/png,image/jpg,image/gif" id="item-image"/>
            ...
            <div class="form-group mt-3">
              ...
              <select name="category" class="custom-select form-control @error('category') is-invalid @enderror" id="">
